...
string RequestChannel::send_request(string _request) {
  ...
  numTimesRun++; // calculate avergage runtime

  printf(" REQUEST time: %f MICROSECONDS\n", time_elapsed_in_seconds * 1000000);

  printf("Average REQUEST time is: %f microSeconds\n\n", (runTime / numTimesRun) * 1000000);
